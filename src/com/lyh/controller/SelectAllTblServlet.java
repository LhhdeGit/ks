...
import com.lyh.service.TblpurchaseService;
...
@WebServlet(name = "SelectAllTblServlet",urlPatterns ="/SelectAllTblServlet" )
public class SelectAllTblServlet extends HttpServlet {
    @Override
